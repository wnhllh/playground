...
export const CodeGenerator = ({ id, defaultCode }) => {
  ...
  // 使用 id（projectCode）或 selectedId 来获取代码
  const codeToDisplay = generatedCodes[id] || generatedCodes[selectedId] || defaultCode || fallbackCode;

  console.log('CodeGenerator: id', id);
