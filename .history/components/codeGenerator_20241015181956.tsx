...
export const CodeGenerator = ({ id, defaultCode, mode }) => {
  ...
  // 根据模式选择正确的代码来显示
  const codeToDisplay = mode === 'edit' 
    ? (generatedCodes[id] || defaultCode || fallbackCode)
    : (generatedCodes[selectedId] || defaultCode || fallbackCode);
